...
(window.webpackJsonp=window.webpackJsonp||[]).push([[33],{LYVK:function(t,i,n){"use strict"
n.r(i)
var r=n("q1tI"),o=n.n(r),a=n("Tils"),e=n("KQw/"),g=n("y1Xp"),d=n("NFr/"),s=n.n(d),c=n("17x9"),m=function TabItem(t){var i=Object(g.a)(s.a,t.classes),n=t.minHeight,r=t.verticalAlignment,d=t.backgroundColor,c=t.desktopImage,m=t.mobileImage,b=t.backgroundSize,p=t.backgroundPosition,l=t.backgroundAttachment,u=t.backgroundRepeat,h=t.textAlign,f=t.border,k=t.borderColor,v=t.borderWidth,w=t.borderRadius,y=t.marginTop,R=t.marginRight,j=t.marginBottom,x=t.marginLeft,I=t.paddingTop,T=t.paddingRight,A=t.paddingBottom,C=t.paddingLeft,L=t.children,O=t.cssClasses,B=void 0===O?[]:O,H=c
m&&"function"==typeof window.matchMedia&&window.matchMedia("(max-width: 768px)").matches&&(H=m)
var N={minHeight:n,verticalAlignment:r,backgroundColor:d,textAlign:h,border:f,borderColor:k,borderWidth:v,borderRadius:w,marginTop:y,marginRight:R,marginBottom:j,marginLeft:x,paddingTop:I,paddingRight:T,paddingBottom:A,paddingLeft:C}
